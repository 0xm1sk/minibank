    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-gray-800 shadow-md rounded-lg p-6">
                <h3 class="text-lg font-semibold text-gray-200 mb-4">Withdraw Money</h3>
                ...
                <form method="POST" action="{{ route('client.withdraw.store') }}">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <p class="mt-1 text-xs text-yellow-400">⚠️ Withdrawals over $50,000 require admin approval</p>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="description" 
                                  ...
                                  rows="3"
                                  class="block w-full rounded-md bg-gray-700 border-gray-600 text-gray-200 focus:border-indigo-500 focus:ring-indigo-500"
                                  placeholder="e.g., ATM withdrawal, Store purchase, etc.">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="flex items-center justify-end">
                        ...
                        <button type="submit" class="px-4 py-2 bg-red-600 text-white font-medium rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:ring-offset-gray-800">
                            Withdraw Money
                        </button>
                    </div>
                </form>
